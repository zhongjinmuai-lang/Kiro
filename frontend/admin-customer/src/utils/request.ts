...
/**
 * 终端客户后台 HTTP 客户端（v2.4）
 * 修复：localStorage key 改为 mu_cust_token 避免多端冲突 + 添加 refresh 逻辑
 */
const baseURL = (import.meta as any).env?.VITE_API_BASE_URL || ''

const STORAGE_KEY_TOKEN = 'mu_cust_token'
const STORAGE_KEY_REFRESH = 'mu_cust_refresh'
